...
const App = () => {
  ...
  const radioList = [
    { text: 'Activate select', value: '0' },
    { text: 'Activate checkbox', value: '1' },
    { text: 'Disable both', value: '2' },
  ];
        ...
        <Form submitAction={submitAction} invalidAction={invalidAction}>
          ...
          <div className='row d-flex align-items-end'>
            <FormContext.Consumer>
              {({ formValues }) => (
                <>
                  <div className='col-12 col-md-4 mt-15'>
                    <Select
                      label='Initial text'
                      options={selectOptions}
                      name='disabledSelect'
                      errorMessage='Error select'
                      defaultValue='1'
                      disabled={!!formValues.radioGroup && formValues.radioGroup.value !== '0'}
                    />
                  </div>
                  <div className='col-12 col-md-4 mt-15'>
                    <Checkbox
